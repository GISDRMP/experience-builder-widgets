export default {
  ...
  csvExportFields: 'CSV export fields',
  csvExportFieldsHint: 'Choose which fields can be exported to CSV for the selected layer.',
  atlasMapSync: 'Atlas map sync',
  atlasMapSyncHint: 'Connect this List to the Map widget. It reads the first feature layer in the web map, so no layer ID is required.',
  atlasMapWidget: 'Map widget',
  atlasEnableSync: 'Enable map sync',
  atlasZoomOnListClick: 'Zoom to map when list item is clicked',
  atlasSelectOnMapClick: 'Select list item when map feature is clicked',
  atlasFilterMapWithList: 'Filter map with list search/filter',
  atlasSelectionZoom: 'Selection zoom level'
}
